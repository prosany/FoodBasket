            ...
            <div className="ProductOptions">
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="FormDesign">
                        ...
                        <input className="InputText" id="ProductName" name="name" placeholder="Green Capsicum - 250 gm" ref={register({ required: true })} />
                        <p className="ErrorMSG">{errors.name && <span>This field is required</span>}</p>
                    </div>
                    <div className="FormDesign">
                        <label htmlFor="ProductPrice">Product Price</label><br />
                        <input className="InputText" id="ProductPrice" name="price" placeholder="25" ref={register({ required: true })} /><br />
                        <p className="ErrorMSG">{errors.price && <span>This field is required</span>}</p>
                    </div>
                    <div className="FormDesign">
                        <label htmlFor="ProductWeight">Product Weight</label><br />
                        <input className="InputText" id="ProductWeight" name="weight" placeholder="500 gm" ref={register({ required: true })} /><br />
